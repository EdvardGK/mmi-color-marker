...
(Repo and hostname history: started as "MMI 700 Fargelegger" for marking MMI=700 elements;
renamed 2026-09-04 since it colour-codes anything by property.)
...
- **Self-hosted** (`fargekoding.skiplum.com`, since 2026-09-04): the `Dockerfile` here, run on
